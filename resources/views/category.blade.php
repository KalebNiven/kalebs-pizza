    ...
    <div class="container px-5">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 text-center">
                ...
                <h1 class="coloredText mb-0 display-4 fw-500 d-flex justify-content-center">Category</h1>
                <span hidden="" class="alt_coloredText"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Category</font></font></span>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card p-3 bg-gray">
                            ...
                            <div class="card-body p-0 text-center mt-2">
                              ...
                              <a href="{{ route('catalog') }}?dir=category&i={{ $item->id }}" class="btn btn-danger btn-sm br-25 view-btn">
                                  View More
                              </a>
                            </div>
                          </div>
